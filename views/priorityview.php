...
include_once '../classes/projects.classes.php';
...
class UserSession {
    ...
    public function displayProjectmain () {
        $managermain = new ProjectMain;
        $managermain->getProjectquery();
    }
...
$userSession->displayProjectmain();
