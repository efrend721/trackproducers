...
include_once '../classes/projectlistphotoview.classes.php';
...
class UserSession {
    ...
    public function displayProjectlistPhoto () {
        $managermain = new ProjectListPhoto;
        $managermain->getProjectListPhoto();
    }
...
$userSession->displayProjectlistPhoto();
