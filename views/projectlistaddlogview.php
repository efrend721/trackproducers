...
include_once '../classes/projectlistaddlog.classes.php';
...
class UserSession {
    ...
    public function displayProjectlistAddLog () {
        $managermain = new ProjectListAddLog;
        $managermain->getProjectListAddLog();
    }
...
$userSession->displayProjectlistAddLog();
?>
<script>
