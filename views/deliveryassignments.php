...
include_once '../classes/deliveryassignments.classes.php';
...
class UserSession {
    ...
    public function displayProjectDeliveryMain () {
        $managermain = new ProjectDeliveryMain;
        $managermain->getProjectDeliveryQuery();
    }
...
$userSession->displayProjectDeliveryMain();
