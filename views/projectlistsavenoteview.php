...
include_once '../classes/projectlistsavenote.classes.php';
...
class UserSession {
    ...
    public function displayProjectlistSaveNote () {
        $managermain = new ProjectListSaveNote;
        $managermain->getProjectListSaveNote();
    }
...
$userSession->displayProjectlistSaveNote();
?>
