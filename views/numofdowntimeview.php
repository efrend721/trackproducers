...
include_once '../classes/numofdowntime.classes.php';
...
class UserSession {
    ...
    public function displayDowntime () {
        $downtimemain = new DowntimeMain;
        $downtimemain->setNumofdowntime();
    }
