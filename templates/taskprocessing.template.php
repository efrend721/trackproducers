<?php
function renderTaskDetails($dbh, $user_id, $area, $idstation, $sqlTask, $contenedorStyle, $calloutinfo) {
                    ...
                    <div class='card-body'>
                        <div class='shadow row mb-2 p-2 bg-dark border rounded-3 text-white'>
                            <div class='row g-2'>
                                ...
                                <div class='col-2'><span>Priority</span></div>
                                <div class='col-2'><span>Date</span></div>
                                <div class='col-2'><span class='float-end'>Processs</span></div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            echo "<div class='card'>
                    <div class='card-body'>
                        <div class='row mb-1 p-1 border rounded-3 text-black' style='$contenedorStyle'>
                            ...
                            <div class='row g-2'>
                                <div class='col-md-6'><span>$result2[address]</span></div>
                                <div class='col-md-2'><span class='badge' style='background-color: #c2593f;'>$result2[nm_priority]</span></div>
                                <div class='col-md-2'><span>$result2[date]</span></div>
                                <div class='col-md-2'><button type='submit' name='process' value='$result2[id_project]' class='btn btn-primary btn-sm float-end' style='background-color: #567ebb;'>Finish</button></div>
                            </div>
                            </form>
                        </div>";
            echo "<div class='row'>
    ...
    /*if ($driver == $user_id) {
        echo "<br>
            <div class='card'>
                <div class='card-body'>
                    <span><i class='bi bi-table me-2'></i></span>Driver : {$user_id}
                </div>
            </div>
            <br>";
            ...
            <div class='card-body'>
                ...
                foreach ($results as $result) {
                    echo "<div class='shadow row mb-2 p-2 bg-secondary border rounded-3 text-white'>
                            <div class='row g-2'>
                                <div class='col-sm-6'><span>$result[address]</span></div>
                                <div class='col-sm-2'><span class='badge text-bg-danger'>$result[nm_priority]</span></div>
                                <div class='col-sm-2'><span>$result[date]</span></div>
                                <div class='col-sm-2'><button type='submit' name='process' value='$result[id_project]' class='btn btn-primary float-end' style='background-color: #567ebb;'>Start</button></div>
                            </div>
                        </div>";
                    }
                echo "
