<?php 
function renderTaskMobile ($dbh, $user_id, $sqlTask, $area, $idstation, $contenedorStyle, $calloutinfo ) {
ob_start();
                ...
                echo "<div class='card p-1'>
                        ...
                        <div class='card-body'>    
                            <div class='shadow row mb-3 p-3 bg-dark border rounded-3 text-white'>
                                <div class='col-2'><span>Cart</span></div>
                                <div class='col-5'><span>Addres</span></div>
                                ...
                                <div class='card-body'>
                                    <form action='../classes/taskexecute.classes.php' method='POST'>
                                        <div class='shadow row mb-3 p-3 border rounded-3 text-black' style='$contenedorStyle'>
                                            <div class='col-2 text-truncate'><span>$cart</span></div>
                                            <div class='col-5 text-truncate'><span>$address</span></div>
                        ...
                        <form action='../classes/taskexecute.classes.php' method='POST'>";
                            ...
                            echo "<div class='shadow row mb-2 p-1 border rounded-3 text-black' style='$contenedorStyle'>
                                    <div class='row g-2'>
                                        ...
                                        <div class='col-2'><span>$date</span></div>
                                        <div class='col-2'><button type='submit' name='process' value='$result[id_project]' class='btn float-end' style='background-color: #92b35a;'>Start</button></div>    
                                    </div>
                                </div>";
                            }
                            echo "
                    ...
                    <div class='card-body'>
                        <form action='../classes/taskexecute.classes.php' method='POST'>";
                            ...
                            echo "<div class='shadow row mb-2 p-1 border rounded-3 text-black' style='$contenedorStyle'>
                                    <div class='row g-2'>
                                        <div class='col-2'><span>$cart</span></div>
                                        <div class='col-5'><span>$address</span></div>
                                        <div class='col-3'><span class='badge' style='background-color: #c2593f;'>{$priority}</span></div>
                                        <div class='col-2'><button type='submit' name='process' value='$result[id_project]' class='btn float-end' style='background-color: #92b35a;'>Start</button></div>    
                                    </div>
                                </div>";
                            }
