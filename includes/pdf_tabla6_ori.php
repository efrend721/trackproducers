...
$stmtOperators->bindParam(':startDate', $startDate, PDO::PARAM_STR);
$stmtOperators->bindParam(':endDate', $endDate, PDO::PARAM_STR);
...
$stmtTimes->bindParam(':startDate', $startDate, PDO::PARAM_STR);
$stmtTimes->bindParam(':endDate', $endDate, PDO::PARAM_STR);
...
$baseFileName = 'dtr_range_date_single_machines'; // Abbreviation for "downtime_report_daylyall_machine"
